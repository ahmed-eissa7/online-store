...
function renderProduct(continer , productFn) {
  
  products.filter(productFn).forEach(product => {
...
renderProduct( products_sale , pro => pro.old_price )

// Electronics
let Electronics = document.getElementById("Electronics");
renderProduct( Electronics , pro => pro.catetory === "electronics"); 

// appliances
let appliances = document.getElementById("appliances");
renderProduct( appliances , pro => pro.catetory === "appliances");

// mobiles
let mobiles = document.getElementById("mobiles");
renderProduct( mobiles , pro => pro.catetory === "mobiles");
